...
using YotorResources.Repositories;

namespace YotorResources
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
          ...
          options => {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "YotorResources", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "YotorResources v1"));
            }
